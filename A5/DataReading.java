...
public class DataReading {
  ...
  public int hashCode() { //redo this; compiles but might have collisions
    long total = ((getMin() % 7) + (getMax() % 7));
    long timeFrame = total + timestamp;
    String intTime = Long.toString(timeFrame); //don't want this to be a string right?
    return intTime.hashCode();
  }
}
